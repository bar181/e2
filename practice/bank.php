...
$dime_value = .10;
$quarter_value = .25;
# $0.50 piece added for q8
$half_dollars_value = .5;
...
$total = ($pennies * $penny_value) + ($nickels * $nickel_value) + ($dimes * $dime_value) + ($quarters * $quarter_value)  + ($half_dollars * $half_dollars_value);;
